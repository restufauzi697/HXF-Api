...
function otakudesu(judul){
	...
	axios.get('https://otakudesu.best/?s=' + judul + '&post_type=anime')
	.then(({ data }) => {
...
function ongoing(){
	return new Promise((resolve,reject) => {
		axios.get('https://otakudesu.best/ongoing-anime/').then(({ data}) => {
			const $ = cheerio.load(data)
			const result = [];
			const img = [];
			const epz = [];
...
function sholat(NO) {
	return new Promise(async(resolve, reject) =>{
		const date = new Date()
		axios.get(`https://kalam.sindonews.com/jadwalsholat/${NO}/${date.getMonth()+1}/${date.getFullYear()}`).then(({ data }) => {
			const $ = cheerio.load(data)
			const result = {};
...
module.exports.otakudesu = otakudesu // work
module.exports.covid = covid // Not-work
module.exports.ongoing = ongoing // work
module.exports.komiku = komiku
module.exports.tebakgambar = tebakgambar // work
module.exports.surah = surah // work
module.exports.sholat = sholat // work
...
module.exports.youtube = youtube // Not-work
module.exports.ttdownloader = ttdownloader // Not-work
