...
<p align="center">
<a href="##"><img title="hexa-api" src="https://img.shields.io/static/v1?label=package&message=hxf-api&color=red"></a>
</p>
<p align="center">
...
<p align="center">
<a href="#"><img title="mengapi" src="https://img.shields.io/static/v1?label=FREE&message=hxf-api&color=pink"></a>
</p>

## ```INSTALL And UNINSTALL```
> npm install hxf-api
>  
> npm uninstall hxf-api


## ```Otakudesu```
``` 
const hx = require('hxf-api');
const judul = 'kaifuku'
